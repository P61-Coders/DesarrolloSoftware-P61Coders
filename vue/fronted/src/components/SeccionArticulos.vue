  ...
  <v-container>
    ...
    <section class="seccion-articulos">
      <article class="verduras" v-if="categorias[1].activo === true">
        ...
        <img
          class="verduras_imagen"
          src="@/assets/images/verduras.jpg"
          alt="Verduras colombianas"
        />
        <p class="verduras_descripcion">
          Click aquí para encontrar las mejores y todas las <br />
      ...
      <article class="otros" v-if="categorias[0].activo === true">
        ...
        <img
          class="otros_imagen"
          src="@/assets/images/exoticas.jpg"
          alt="exoticos colombianas"
        />
        <p class="otros_descripcion">
          Clic aquí para encontrar las mejores <br />
          frutas y verduras orgánicas y/o exóticas
      ...
      <article class="frutas" v-if="categorias[2].activo === true">
        ...
        <p class="frutas_descripcion">
          ...
          frutas de nuestro campo colombiano
...
.verduras_descripcion > a {
  color: rgb(27, 75, 0);
}
.verduras_descripcion {
  margin-top: 5px;
  text-align: center;
}
