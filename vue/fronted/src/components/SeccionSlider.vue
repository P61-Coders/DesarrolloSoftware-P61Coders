<template>
     <!-- Seccion Slider - Desarrollada por David Fonseca -->
    <div class="slider-area">
        <div class="slider-active">
            <div class="single-slider slider-height slider-padding sky-blue d-flex align-items-center">
                <div class="container">
                    <div class="row d-flex align-items-center justify-items-start">
                        <div class="col-lg-6 col-md-9 col-left">
                            <div class="hero__caption">
                                <span data-animation="fadeInUp" data-delay=".4s">VIVELO CON NOSOTROS</span>
                                <h1 data-animation="fadeInUp" data-delay=".6s">Mercar hecho facil<br>con Fruver</h1>
                                ...
                                <!-- Slider btn -->
                                <div class="slider-btns pl-0">
                                    <!-- Hero-btn -->
                                    <router-link class="nav-link" :to="{name: 'Frutas'}">
                                        <button-2 data-animation="fadeInLeft" data-delay="1.0s" :name="buttonName" ></button-2>
                                    </router-link>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="hero__img d-none d-lg-block f-right" data-animation="fadeInRight" data-delay="1s">
                                <img class="hero_img" src="@/assets/images/Image-hero.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
