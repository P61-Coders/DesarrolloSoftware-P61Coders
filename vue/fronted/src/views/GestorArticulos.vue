...
export default {
  ...
  methods: {
    ...
    categoriasListar() {
      axios
        .get("https://app-fruver-backend.herokuapp.com/api/categoria/listActivos")
        .then((response) => {
    ...
    list() {
      ...
      axios
        .get("https://app-fruver-backend.herokuapp.com/api/articulo/list")
        .then((response) => {
    ...
    deleteItemConfirm() {
      if (this.editedIndex > -1) {
        axios
          .delete("https://app-fruver-backend.herokuapp.com/api/articulo/remove", {
    ...
    save() {
      if (this.editedIndex > -1) {
        axios
          .put("https://app-fruver-backend.herokuapp.com/api/articulo/update", {
        ...
        axios
          .post("https://app-fruver-backend.herokuapp.com/api/articulo/add", {
            nombre: this.editedItem.nombre,
            descripcion: this.editedItem.descripcion,
            codigo: this.editedItem.codigo,
            precioXkilo: this.editedItem.precioXkilo,
